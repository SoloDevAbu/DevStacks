    ...
    items: [
      {
        ...
        content: `The data controller is ${SITE_CONFIG.name} (${SITE_CONFIG.domain}), reachable at ${SITE_CONFIG.supportEmail}. This Privacy Policy explains how ${SITE_CONFIG.name} collects, uses, shares, and protects your personal data when you visit our website, submit developer tools or products, authenticate as a maker, or interact with our APIs and machine-readable surfaces.\n\nWe respond to verified data-subject requests within 30 days.`,
      },
      {
        id: "data-we-collect",
        number: 2,
        ...
        bulletPoints: [
          ...
          "Payment & Sponsorship Data: Transaction IDs, sponsorship tiers, and invoice statuses. Credit card numbers, CVVs, and banking credentials are handled directly by our PCI-DSS compliant payment processor (Dodo Payments) and never touch our servers.",
          ...
          "Analytics Data: Aggregated page views, referral sources, and device categories collected via Vercel Analytics and Google Analytics (GA4) to understand platform usage trends without selling personal data.",
          `Communications: Direct inquiries sent to ${SITE_CONFIG.supportEmail} or questions regarding listing reviews.`,
        ],
      },
      {
        id: "how-we-use-data",
        ...
        bulletPoints: [
          ...
          "Sponsorship Delivery: Fulfilling booked sidebar advertising placements, managing invoices, and verifying backlink activations via Dodo Payments.",
          "Transactional Notifications (Upcoming): Sending listing approval notices, editorial feedback, and critical account security alerts once automated notifications are fully integrated.",
    ...
    items: [
      ...
      },
      {
        ...
        bulletPoints: [
          ...
          "Payments & Billing: Dodo Payments Inc. (PCI-DSS compliant merchant of record and payment gateway handling sponsorships, invoices, and customer billing details).",
          "Analytics & Telemetry: Google LLC (Google Analytics 4 for aggregated site usage metrics) and Vercel Analytics.",
          "Transactional Communications (Planned): Resend or equivalent email delivery providers (for future automated listing approval notices and editorial communications).",
          "Public AI Engine Indexing: Publicly available directory listings and open tech-stack data may be indexed by third-party search and answer engines (including Anthropic, OpenAI, Perplexity, and Google) via public endpoints (/llms.txt, /api/mcp). User-private dashboard data and account settings are strictly excluded.",
    ...
    items: [
      ...
      },
      {
        ...
        bulletPoints: [
          ...
          `To exercise any of these rights, contact us at ${SITE_CONFIG.supportEmail}. We respond to all verified requests within 30 days without charge.`,
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        content: `We prioritize user privacy and use strictly necessary first-party cookies for authentication, session persistence, and CSRF protection via BetterAuth. We also utilize Google Analytics (GA4) measurement cookies (_ga, _ga_*) to analyze aggregated web traffic and enhance platform performance. We do not deploy third-party advertising retargeting trackers or cross-site behavioral advertising scripts.`,
      },
      {
        id: "ai-agents-and-crawlers",
        number: 11,
        title: "AI Agents, Crawlers & LLM Indexing",
        content: `${SITE_CONFIG.name} explicitly authorizes transparent search and answer engine crawlers (including GPTBot, ClaudeBot, PerplexityBot, Applebot-Extended, and Google-Extended) to index public directory pages in compliance with our published robots.txt and ai.txt policies.\n\nAI models and agents are permitted to access and answer queries using only publicly available directory information (such as approved tool and product profiles, taglines, architectural "Built With" relationships, categories, and public community scores). We strictly safeguard user-private data: under no circumstances are private user analytics, draft submissions, personal account settings, or private authenticated data accessible in /dashboard views ever shared with or ingested by AI models or crawlers. Automated systems are forbidden from attempting to scrape private or non-public endpoints.`,
      },
      {
        id: "childrens-privacy",
        number: 12,
        title: "Children's Privacy",
        content: `${SITE_CONFIG.name} is designed exclusively for software developers, engineers, and technical founders. It is not directed at children under the age of 16. We do not knowingly collect personal data from minors. If you believe a minor has registered an account, contact ${SITE_CONFIG.supportEmail} and we will promptly delete the data.`,
      },
      {
      ...
      },
      {
        ...
        content: `We may update this Privacy Policy to reflect platform enhancements, legal amendments, or new service integrations. The "Last updated" date at the top of this document indicates the current effective version. For substantive changes, we will provide conspicuous notice on our website or platform announcement.`,
      },
      {
        id: "contact-privacy",
        number: 15,
