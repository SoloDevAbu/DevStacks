export const PLATFORMS = [
  { id: "Web", label: "Web Application", logo: "/social-logo/world-wide-web.png" },
  { id: "iOS", label: "Mobile App (iOS)", logo: "/social-logo/app-store.png" },
  { id: "Android", label: "Mobile App (Android)", logo: "/social-logo/playstore.png" },
  { id: "macOS", label: "Desktop (macOS)", logo: "/social-logo/happy-mac.png" },
  { id: "Windows", label: "Desktop (Windows)", logo: "/social-logo/windows.png" },
  ...
  { id: "Extension", label: "Browser Extension", logo: "/social-logo/chrome.png" },
