        ...
        <form className="flex flex-col">
          ...
          <div className="flex flex-col gap-6 border-b border-dashed border-border px-6 py-8 md:px-8">
            ...
            <div className="flex flex-col gap-4">
              <div className="grid gap-2">
                ...
                <Textarea id="problem" placeholder="What pain point does this project eliminate?" rows={3} />
              </div>
              <div className="grid gap-2">
                <Label htmlFor="solution">The Solution</Label>
                <Textarea id="solution" placeholder="How does your project solve this problem?" rows={3} />
              </div>
              <div className="grid gap-2">
          ...
          <div className="flex flex-col gap-6 border-b border-dashed border-border px-6 py-8 md:px-8">
            <div>
              ...
              <p className="text-sm text-slate-500">
                Where can developers use your project?
              </p>
            </div>
          ...
          <div className="flex flex-col gap-6 border-b border-dashed border-border px-6 py-8 md:px-8">
            <div>
              ...
              <p className="text-sm text-slate-500">
                Where can people find your project and your community?
              </p>
            </div>
