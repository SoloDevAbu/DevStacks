      ...
      <div className="relative flex min-h-full flex-col items-center justify-center gap-6 bg-slate-50/50 p-12 text-center">
        ...
        <div className="max-w-md">
          ...
          <p className="mt-2 text-sm text-slate-600">
            Your build has been submitted for moderation. As part of our launch celebration, your product listing will receive a complimentary upgrade to{" "}
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-600">
                    Showcase your build today and receive an automatic upgrade to Verified Premium status ({LAUNCH_PROMO.VALUE_GIFTED} value) upon approval.
                  </p>
                </div>
              </div>
          ...
          <div className="flex flex-col border-b border-dashed border-border">
            ...
            <div className="flex flex-col gap-5 border-b border-dashed border-border px-6 py-6 md:px-8 md:py-8">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-xs text-slate-500">
                  Product demo video and walkthrough. Brand favicon is automatically fetched from your website URL.
                </p>
              </div>
