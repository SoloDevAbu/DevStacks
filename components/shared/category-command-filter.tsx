    ...
    <>
      <div className="group/btn relative inline-flex">
        <Button
          ...
          className={cn(
            "relative z-10 h-auto gap-2 rounded-lg border-slate-200 bg-white px-3 py-1.5 text-xs font-medium shadow-xs transition-colors hover:bg-slate-50",
            !isAllSelected &&
              "border-indigo-200 bg-indigo-50/70 font-semibold text-indigo-700 hover:bg-indigo-100/70",
            buttonClassName
          )}
        >
          <Layers
      ...
      <CommandDialog
        ...
        description="Search and filter developer tools and products by category"
      >
