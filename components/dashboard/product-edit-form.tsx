...
export const ProductEditForm = ({ product }: ProductEditFormProps) => {
  ...
  const updateMutation = useUpdateProduct(product.slug)

  const [name, setName] = useState<string>(product.name || "")
  const [tagline, setTagline] = useState<string>(product.tagline || "")
  const [description, setDescription] = useState<string>(product.description || "")
  const [websiteUrl, setWebsiteUrl] = useState<string>(product.websiteUrl || "")
  ...
  const [solution, setSolution] = useState(product.solution || "")
  const [uniqueValue, setUniqueValue] = useState(product.uniqueValue || "")
  const [useCases, setUseCases] = useState(product.useCases || "")

  // Social & Store Links
  const [githubUrl, setGithubUrl] = useState(product.githubUrl || "")
  const [twitterUrl, setTwitterUrl] = useState(product.twitterUrl || "")
  const [linkedinUrl, setLinkedinUrl] = useState(product.linkedinUrl || "")
  const [discordUrl, setDiscordUrl] = useState(product.discordUrl || "")
  const [demoVideoUrl, setDemoVideoUrl] = useState(product.demoVideoUrl || "")
  const [appStoreUrl, setAppStoreUrl] = useState(product.appStoreUrl || "")
  const [playStoreUrl, setPlayStoreUrl] = useState(product.playStoreUrl || "")
  ...
  return (
    <div className={dashboardPageContainer}>
      <form onSubmit={handleSubmit} className="flex flex-col">
        ...
        <div className="flex flex-col gap-4 border-b border-dashed border-border bg-white px-6 py-6 md:px-8 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            <Button
              ...
              render={<Link href={ROUTES.DASHBOARD_PRODUCTS} />}
            >
        ...
        <div className={dashboardFormSection}>
          <div>
            ...
            <p className={dashboardFormSectionSubtitle}>
              Core metadata for directory search cards and display feeds.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <Input
                ...
                placeholder="One sentence describing the product"
                className="h-9 text-xs"
                required
              />
            </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <Input
                ...
                placeholder="e.g. nextjs, typescript, ai"
                className="h-9 text-xs"
              />
            </div>
        ...
        <div className={dashboardFormSection}>
          <div>
            <h2 className={dashboardFormSectionTitle}>Links & Media</h2>
            <p className={dashboardFormSectionSubtitle}>
              Website URL and social links used for outbound traffic tracking.
            </p>
          </div>
        ...
        <div className={dashboardFormSection}>
          <div>
            <h2 className={dashboardFormSectionTitle}>Deep Dive Showcase</h2>
            <p className={dashboardFormSectionSubtitle}>
              Provide detailed technical architectural clarity for developer users.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="flex flex-col gap-1.5">
              ...
              <Textarea
                ...
                placeholder="What critical challenge does this application solve?"
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <Textarea
                ...
                placeholder="How was this built and how does it deliver value?"
                className="min-h-20 text-xs"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Input
              ...
              placeholder="What makes your product distinct from alternatives?"
              className="h-9 text-xs"
            />
          </div>
        </div>
        ...
        <div className={dashboardFormSection}>
          <div className="flex items-center justify-between">
            <div>
              <h2 className={dashboardFormSectionTitle}>Frequently Asked Questions</h2>
              <p className={dashboardFormSectionSubtitle}>
                Add FAQs to directly address questions from builders and customers.
              </p>
            </div>
            <Button
              type="button"
